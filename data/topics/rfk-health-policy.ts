  ...
  pillars: [
    ...
    // =========================================================================
    {
      ...
      crux: {
        ...
        description:
          "The disagreement turns on whether the cumulative current schedule — total adjuvant load, dose timing, and shot-stacking — carries net harms not captured by component-level studies. A definitive answer requires comparing health outcomes of children on the full schedule versus a lighter schedule. The decisive question is whether such a comparison can be done rigorously and ethically, since withholding established vaccines from a control group would expose children to known, preventable disease.",
        methodology:
