      ...
      evidence: [
        {
          ...
          title: "Adolescent Brain Maturation Continues Into the Twenties",
          description:
            "Neuroscience research consistently shows that the prefrontal cortex — supporting executive function, long-term planning, risk assessment, and impulse control — continues to mature into the early-to-mid twenties. Importantly, there is no validated 'fully developed at 25' threshold; maturation is gradual and varies between individuals, and the popular 'age 25' figure overstates the precision of the science. What is well-supported is that adolescents, especially under emotional arousal or peer influence, are more likely to weight immediate rewards over long-term consequences and are still developing the capacity to envision their future selves. This developmental reality applies to all adolescent medical decision-making, not just gender-affirming care.",
          side: "against" as const,
          weight: {
            sourceReliability: 8,
            independence: 8,
          ...
          reasoning:
            "That brain maturation continues into the twenties is well-established and independently replicated; however, the specific 'fully mature at 25' framing is a popular oversimplification not supported by a clean cut-off in the data, so sourceReliability and replicability are scored below the maximum. Directness is low because this evidence applies to all adolescent medical decision-making, not specifically to gender-affirming care. The same logic would argue against allowing adolescents to consent to psychiatric medication, oncology treatment, or any other medical intervention with long-term consequences — a standard that is not consistently applied. Adolescents can and often do make competent medical decisions.",
        },
        {
          id: "detransition-regret-rates",
          title: "Detransition and Regret Rates: Low but Methodologically Uncertain",
          description:
            "Studies consistently report low regret rates for gender-affirming care, typically 1-5%. A widely cited 2021 meta-analysis (Bustos et al., Plastic and Reconstructive Surgery – Global Open) found a roughly 1% prevalence of regret across 27 studies of gender-affirming surgery. However, these studies overwhelmingly assess adults undergoing surgery, not adolescents on puberty blockers or hormones, so their applicability to minors is limited. The Cass Review and others identified severe methodological problems with regret studies: they typically measure regret only among those who remain in contact with gender clinics (excluding those who detransition and seek care elsewhere), follow-up periods are often under 5 years, and there is no standardized definition of 'regret.' The growing visibility of detransitioners — individuals who pursued transition and later reversed course — suggests the true regret or discontinuation rate among the current adolescent cohort is genuinely uncertain rather than reliably low.",
          side: "against" as const,
          weight: {
            sourceReliability: 6,
            independence: 6,
          ...
          source: "Bustos et al., Plastic and Reconstructive Surgery – Global Open (2021); Cass Review",
          sourceUrl: "https://pubmed.ncbi.nlm.nih.gov/33968550/",
          reasoning:
