...
export const returnToOfficeProductivityData = {
  ...
  pillars: [
    ...
    // =========================================================================
    {
      ...
      skeptic_premise:
        "RTO mandates are often a proxy for management control rather than a genuine productivity intervention. Multiple companies have used RTO mandates as a soft layoff strategy — forcing attrition among employees unwilling to return, avoiding severance costs. Amazon's leaked internal communications explicitly discussed using RTO compliance as a workforce reduction tool. Companies with large commercial real estate portfolios face occupancy-justification and sunk-cost pressures that create incentives to fill offices regardless of productivity data — though the strength of that link remains an open empirical question rather than a documented correlation. A March 2024 BambooHR survey of 1,504 U.S. desk workers found that 25% of VP and C-suite executives, and 18% of HR professionals, admitted they had hoped for some voluntary turnover when implementing an RTO mandate; nearly a third (32%) of managers said a main goal of RTO was to monitor employees.",
      proponent_rebuttal:
        "Attributing RTO mandates entirely to cynical motives ignores legitimate organizational concerns. Company culture — shared values, mentorship, trust — is genuinely harder to build and maintain when employees never meet in person. New hires and junior employees consistently report feeling more isolated and receiving less mentorship in fully remote settings. Gallup's 2024 data shows that flexible arrangements outperform on-site-only work — remote (~36%) and hybrid (~35%) employees report comparable engagement, both above on-site, while hybrid workers lead on 'thriving' wellbeing (62% vs 59% remote and 50% on-site). The honest reading is not that more office time raises engagement, but that some in-person contact (hybrid) plausibly helps wellbeing and culture without the costs of a strict full-time return. The 'stealth layoff' narrative, while sometimes true, doesn't explain why companies continue hiring while mandating RTO. Real estate costs are a factor but represent only 5-10% of most firms' operating expenses — not enough to drive a policy that risks losing top talent. Leadership at companies like Apple and Google genuinely believe that in-person interaction produces better products, based on decades of internal experience.",
      crux: {
  ...
  references: [
    ...
    {
      title:
        "Return to Office Mandates, Brain Drain and Gender Difference — Ding, Ma, Xing, Yang & Jin (SSRN working paper, 2024)",
      url: "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5031481",
    },
    {
      title:
        "State of the Global Workplace 2024 — Gallup (engagement and wellbeing by work location)",
