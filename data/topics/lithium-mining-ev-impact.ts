      ...
      evidence: [
        {
          ...
          reasoning:
            "USGS is the authoritative source for mineral resource estimates, with maximum institutional credibility and independence. The roughly eightfold growth in identified resources demonstrates that 'peak lithium' concerns are premature. Directness is slightly lower because resource estimates do not equal economically extractable reserves, and the constraint is capacity-building speed rather than geological availability.",
        },
        {
