...
export const seedOilsHealthData = {
  ...
  references: [
    {
      title:
        "Farvid et al., Dietary Linoleic Acid and Risk of Coronary Heart Disease: A Systematic Review and Meta-Analysis of Prospective Cohort Studies — Circulation 2014;130:1568-1578",
      url: "https://www.ahajournals.org/doi/abs/10.1161/circulationaha.114.010236",
    },
    {
      title:
    ...
    {
      title:
        "Hooper et al., Reduction in Saturated Fat Intake for Cardiovascular Disease — Cochrane Database of Systematic Reviews 2020, CD011737",
  ...
  pillars: [
    ...
    // =========================================================================
    {
      ...
      skeptic_premise:
        "The omega-6 to omega-3 ratio has shifted dramatically since the mid-20th century as seed oils replaced animal fats and tropical oils. Linoleic acid (LA), the primary omega-6 in seed oils, is the metabolic precursor to arachidonic acid (AA), which feeds into pro-inflammatory eicosanoid pathways, while omega-3 fatty acids compete for the same enzymes and yield more anti-inflammatory mediators. Ancestral diets contained roughly equal omega-6 and omega-3, whereas modern Western diets deliver ratios of 15:1 to 20:1. The strongest version of the concern is not that dietary LA simply floods the body with AA — controlled human trials do not show that — but that a sustained omega-6-dominant intake, by occupying shared desaturase and eicosanoid pathways and shifting the balance of downstream signaling lipids, could tilt the system toward a more pro-inflammatory state implicated in cardiovascular disease, metabolic syndrome, and autoimmune conditions. Because the body cannot synthesize either fatty acid, diet sets this balance — which is why proponents treat the omega-6:3 ratio, rather than AA levels alone, as the lever worth investigating.",
      proponent_rebuttal:
        "The omega-6 to omega-3 ratio hypothesis sounds intuitive but oversimplifies fatty acid metabolism. Systematic reviews and meta-analyses consistently show that higher linoleic acid intake is associated with reduced cardiovascular risk, not increased risk. The 2009 American Heart Association Science Advisory concluded that consuming at least 5-10% of calories from omega-6 polyunsaturated fats reduces coronary heart disease risk. Importantly, while linoleic acid can theoretically convert to pro-inflammatory arachidonic acid, a systematic review of controlled human trials (Rett & Whelan, 2011) found that changing dietary LA — increasing it up to six-fold or cutting it by up to 90% — did not significantly change tissue arachidonic acid in plasma phospholipids. Conversion through delta-6 desaturase is rate-limiting, so the body holds AA levels largely steady regardless of LA intake. Furthermore, linoleic acid itself produces anti-inflammatory metabolites including lipoxins. The 'ratio' framework ignores that absolute intakes of both omega-6 and omega-3 matter more than their proportion — populations with high omega-6 AND high omega-3 intake (like many Mediterranean populations) have excellent cardiovascular outcomes.",
      crux: {
    ...
    // =========================================================================
    {
      ...
      proponent_rebuttal:
        "The oxidation concern is legitimate for improperly handled oils but overstated for typical consumer use. Modern refining removes the vast majority of oxidation products, and refined seed oils have high smoke points (soybean ~234C, canola ~240C), making them more stable for cooking than many alternatives like butter (~177C) or extra virgin olive oil (~190C). Aldehyde generation scales with frying intensity and is greatest during prolonged, repeated deep frying well above smoke point — conditions more relevant to commercial food service than to a single domestic pan-fry. The honest caveat is that the safety margin for typical home use is not cleanly established: some groups (e.g., Grootveld et al.) report that repeated domestic deep frying with PUFA-rich oils can reach aldehyde levels they characterize as toxicologically significant, so this remains an open dose-response question rather than a settled one. The trace trans fats from deodorization (typically <1% of total fat) are far below levels that drove the trans fat ban, which targeted partially hydrogenated oils containing 25-45% trans fats. Furthermore, oxidation is not unique to seed oils — all cooking fats degrade with heat, including the saturated fats and animal fats proposed as replacements. The relevant question is not whether any degradation occurs but whether it occurs at levels that meaningfully impact health, and population-level evidence does not support harm from normal seed oil use.",
      crux: {
