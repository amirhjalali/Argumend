    ...
    <div className="min-h-[100svh] bg-transparent">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        {!hydrated ? (
          ...
          <div
            className="rounded-xl border border-stone-200/60 dark:border-[var(--border-default)] bg-card/60 p-8 text-center"
            role="status"
            aria-live="polite"
          >
          ...
          <div className="rounded-xl border border-stone-200/60 dark:border-[var(--border-default)] bg-card/60 p-10 text-center">
