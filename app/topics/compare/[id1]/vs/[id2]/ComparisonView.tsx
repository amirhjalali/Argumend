...
> = {
  ...
  impossible: {
    bg: "bg-stone-100 dark:bg-[var(--bg-muted)]",
    ...
    >
      ...
      <div className="h-2.5 rounded-full overflow-hidden flex bg-stone-200/60 dark:bg-[#3d3a36]">
        {total > 0 ? (
          ...
          <div className="h-full w-full bg-stone-200/70 dark:bg-[var(--bg-muted)]" aria-hidden="true" />
        )}
      </div>
      ...
      <div className="min-h-[100svh] bg-[#f4f1eb] dark:bg-[#121210] overflow-x-hidden">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {/* Topic 1 Header */}
            <div className="bg-transparent rounded-xl border border-stone-200/60 dark:border-[var(--border-divider)] p-6">
          ...
          <section className="bg-transparent rounded-xl border border-stone-200/60 dark:border-[var(--border-divider)] p-6 sm:p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link
                ...
                className="group flex flex-col items-center gap-3 rounded-xl border border-stone-200/60 dark:border-[var(--border-divider)] bg-[#faf8f5] dark:bg-[#1a1916] p-6 hover:border-rust-300/50 hover:shadow-md transition-all card-hover"
              >
