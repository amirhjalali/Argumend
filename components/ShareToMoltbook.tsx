        ...
        <AnimatePresence mode="wait">
          ...
          {state === "idle" && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
            >
              <p className="text-sm text-stone-600 dark:text-[var(--text-secondary)] mb-4">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 text-sm font-medium text-stone-600 dark:text-[var(--text-secondary)] bg-stone-100 dark:bg-[var(--bg-muted)] hover:bg-stone-200 dark:hover:bg-[#3d3a36] rounded-lg transition-colors"
                >
                  Preview Post
                </button>
                <button
          ...
          {state === "previewing" && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
            >
              <div className="bg-stone-50 dark:bg-[var(--bg-surface)] rounded-lg p-3 mb-4 max-h-64 overflow-y-auto">
                <pre className="text-xs text-stone-600 dark:text-[var(--text-secondary)] whitespace-pre-wrap font-mono">
                  {formatDebateContent()}
                </pre>
              </div>
          ...
          {state === "rate-limited" && (
            ...
            >
              ...
              <button
                onClick={handleBack}
                className="px-4 py-2 text-sm font-medium text-stone-600 dark:text-[var(--text-secondary)] bg-stone-100 dark:bg-[var(--bg-muted)] hover:bg-stone-200 dark:hover:bg-[#3d3a36] rounded-lg transition-colors"
              >
                Got it
              </button>
            </motion.div>
