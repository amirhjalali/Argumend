...
export function ConfidenceTimelineTable({
  ...
  return (
    <details className="group mt-3 overflow-hidden rounded-lg border border-stone-200/80 bg-white/40 dark:border-[var(--border-default)] dark:bg-card/40">
      ...
      <div className="overflow-x-auto border-t border-stone-200/80 dark:border-[var(--border-default)]">
        <table className="w-full min-w-[34rem] border-collapse text-left text-sm">
          ...
          <thead className="bg-stone-100/60 text-xs uppercase tracking-wide text-stone-500 dark:bg-muted-surface/70 dark:text-stone-400">
            <tr>
