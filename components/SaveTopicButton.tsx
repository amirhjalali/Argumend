...
export function SaveTopicButton({ topicId: _topicId }: SaveTopicButtonProps) {
  ...
  return (
    <button
      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium border bg-white/80 text-stone-400 border-stone-200/60 opacity-50 cursor-default"
